...
7. **Two-Tier Navigation**: Main screens use Jetpack Navigation (`NavHost`). Settings sub-screens use `SettingsSubScreen` enum.
...
# Per-provider (×31 services, using service.prefsKey)
