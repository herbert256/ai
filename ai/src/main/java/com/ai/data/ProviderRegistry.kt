...
object ProviderRegistry {
    ...
    internal val TRACKED_FIELDS: Set<String> = setOf(
        ...
        "promptTokensIncludeCachedTokens",
    ...
    private fun appServiceFieldMap(s: AppService): Map<String, Any?> = mapOf(
        ...
        "promptTokensIncludeCachedTokens" to s.promptTokensIncludeCachedTokens,
    ...
    private fun mergeTrackedFields(existing: AppService, asset: AppService, take: Set<String>): AppService {
        ...
        return AppService(
            ...
            promptTokensIncludeCachedTokens = p("promptTokensIncludeCachedTokens", existing.promptTokensIncludeCachedTokens, asset.promptTokensIncludeCachedTokens),
...
data class ProviderDefinition(
    ...
    /** Whether prompt_tokens already includes cached_tokens /
     *  prompt_tokens_details.cached_tokens. Defaults to OpenAI's shape. */
    ...
    fun toAppService(): AppService {
        ...
        return AppService(
            ...
            promptTokensIncludeCachedTokens = promptTokensIncludeCachedTokens ?: true,
    ...
    companion object {
        fun fromAppService(s: AppService) = ProviderDefinition(
            ...
            promptTokensIncludeCachedTokens = s.promptTokensIncludeCachedTokens.takeIf { !it },
