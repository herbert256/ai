...
internal val glossaryHelp: Map<String, HelpContent> = mapOf(
    ...
    "help_glossary_operations" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Tournament", "Pairwise head-to-head judging over report answers. Each unordered pair is judged in both directions to reduce position bias, then the View screen can aggregate the same match data through Copeland, Elo, Davidson, Tideman, Markov, Schulze, Minimax, Colley, Glicko-2, Points, or TrueSkill2 rankings."),
