...
,
    ...
    "settings_ui" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Title bar layout", "Compact-header mode for detail screens. Default is a fixed title row + a green page-subject line below it. Pick Dynamic subject name to fold the subject into the title bar (the green line hides). Pick Both to render \"<fixed> / <subject>\" in the bar."),
    ...
    "import_export" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Export · Settings", "GeneralSettings (userName, defaultEmail, defaultTypePaths, tracingEnabled, modelNameLayout, subjectToTitleBarMode) as a JSON object. Excludes the three info-provider API keys — those round-trip through API Keys instead."),
