...
internal val RELATED_HOME_HELP: Map<String, List<String>> = mapOf(
    ...
    "report_second_results" to listOf("help_costs", "help_glossary_operations"),
    "report_edit_overview" to listOf("help_glossary_operations", "help_costs", "concepts"),
    "report_create_overview" to listOf("help_glossary_operations", "concepts", "help_costs"),
    "report_edit_icons" to listOf("help_glossary_operations", "concepts"),
    "report_edit_titles" to listOf("help_glossary_operations", "concepts"),
    "report_edit_pair_title" to listOf("help_glossary_operations"),
    "report_edit_model_title" to listOf("help_glossary_operations"),
    ...
    "report_select_workers" to listOf("help_glossary_blocks", "help_glossary_groupings", "help_glossary_operations", "concepts"),
    "report_workers" to listOf("help_glossary_blocks", "help_glossary_groupings", "help_glossary_operations", "concepts"),
    ...
    "report_export_sheet" to listOf("help_glossary_operations", "help_privacy", "help_translations"),
    ...
    "compare_select_prompt" to listOf("help_glossary_operations", "concepts"),
    "compare_l1" to listOf("help_glossary_operations", "concepts", "help_costs"),
    "compare_l2" to listOf("help_glossary_operations", "concepts"),
    "compare_l3" to listOf("help_glossary_operations", "concepts"),
    "secondary_list" to listOf("help_glossary_operations", "concepts"),
    "secondary_detail" to listOf("help_glossary_operations"),
    "rerank_detail" to listOf("help_glossary_operations"),
    "moderation_detail" to listOf("help_glossary_operations"),
    ...
    "ai_crash_reports" to listOf("ai_monitor", "help_privacy"),
    "ai_live_dashboard" to listOf("ai_live_dashboard_edit", "help_privacy"),
    "ai_live_dashboard_edit" to listOf("ai_live_dashboard"),
    "ai_spend_usage" to listOf("help_costs", "help_privacy"),
    "ai_usage_provider" to listOf("help_costs"),
    "ai_usage_type" to listOf("help_costs"),
    "ai_costs_tier" to listOf("help_costs"),
    "ai_stat_reports" to listOf("help_privacy"),
    "ai_stat_providers" to listOf("help_home_info_providers"),
    "ai_stat_models" to listOf("help_home_info_providers"),
    "ai_trace_stats" to listOf("concepts", "help_privacy"),
    "ai_trace_breakdown" to listOf("ai_trace_stats", "concepts"),
    "ai_log_stats" to listOf("concepts", "help_privacy"),
    ...
    "settings_autostart" to listOf("help_glossary_operations", "help_costs"),
    "settings_metadata" to listOf("help_about", "help_costs"),
    "settings_ranking_weights" to listOf("help_glossary_operations", "help_about"),
    ...
    "settings_network_per_provider" to listOf("settings_network", "concepts"),
    ...
    "caches" to listOf("housekeeping", "help_costs"),
    "cache_prompts" to listOf("caches", "help_costs"),
    "cache_icons" to listOf("caches", "help_costs"),
    "cache_meta" to listOf("caches", "help_costs"),
    "cache_modellists" to listOf("caches", "help_costs"),
    "cache_pricing" to listOf("caches", "help_costs"),
    "cache_params" to listOf("caches", "help_costs"),
