...
internal val SCREEN_ICON_HELP: Map<String, List<Triple<String, String, String>>> = mapOf(
    ...
    "report_single_result" to listOf(
        ...
        Triple("✏️", "Edit", "Open the Change response menu — Reload, Edit prompt, Chat (refine in place), Temperature sweep, Reasoning Effort, Web search or Switch model / agent."),
    ...
    "translation_run_l1" to listOf(
        ...
        Triple("🏅", "Translation review", "Review translated passages against their original text (start or open the batch)."),
...
internal val DEFAULT_BAR_ICON_HELP: Map<String, Pair<String, String>> = mapOf(
    ...
    "🏅" to ("Translation review" to "Review translated passages against their original text (start or open the batch)."),
