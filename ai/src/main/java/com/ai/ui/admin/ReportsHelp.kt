...
internal val reportsHelp: Map<String, HelpContent> = mapOf(
    "value_view" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Ranking switch", "The chips at the top pick which ranking feeds the quality axis: Rerank, or any of the Tournament methods (Copeland / Elo / Davidson / Tideman / Markov / Schulze / Minimax / Colley). Tap one and the whole chart, the 💎 best-value pick and the list re-rank instantly — Tournament methods are recomputed locally from the stored win matrix, no new API calls."),
