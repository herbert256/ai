...
,
    ...
    "ai_live_dashboard" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("🧠 Local runtime", "Shown only when an on-device model is loaded or running: which local LLM / embedder models are held in memory and which one (if any) is generating / embedding right now."),
