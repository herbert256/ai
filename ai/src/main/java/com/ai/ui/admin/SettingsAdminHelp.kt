...
,
    ...
    "settings_network_api_calls" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Concurrent Fan Icons API calls", "Cap on the fan-icons batch — the 3-tier emoji-generation chain launched via Find Icons on a fan-out detail screen. Separate cap so a parallel fan-out + fan-icons run doesn't halve each other's budget. Default 50."),
