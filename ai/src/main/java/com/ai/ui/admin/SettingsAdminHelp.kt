...
,
    ...
    "settings_ranking_weights" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Defaults", "Rerank 3, Judges 6, Translations 6, and Elo / Davidson / Tideman 4 each; every other Tournament method starts at 0. The 🧽 in the icons bar resets all sliders to these defaults."),
    ...
    "broken_items" to HelpContent(
        ...
        cards = listOf(
            ...
            HelpCard("Report models", "For a \"Report models\" batch with several broken models, each is a plain row — tap one to open its Model response screen, where you can restart (regenerate) or remove it."),
        )
    ),
