...
object NavRoutes {
    ...
    const val AI_CRASH_REPORTS = "ai_crash_reports"
    ...
    const val AI_USAGE_TYPE_GROUP = "ai_usage_type_group/{groupPrefix}"
    ...
    const val AI_CACHES = "ai_caches"
    const val AI_CACHE_ENTRIES = "ai_cache_entries/{cacheId}"
    ...
    const val AI_REFRESH_INFO_PROVIDERS = "ai_refresh_info_providers"
    const val AI_MANAGE_DATA = "ai_manage_data"
    ...
    fun aiCacheEntries(cacheId: String) = "ai_cache_entries/$cacheId"
    ...
    fun aiUsageTypeGroup(groupPrefix: String) = "ai_usage_type_group/${encode(groupPrefix)}"
