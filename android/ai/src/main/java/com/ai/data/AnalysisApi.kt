...
/**
 * Gson serializer/deserializer for AppService.
...
/**
 * Create a Gson instance with AppService type adapter registered.
 * Use this instead of Gson() when serializing/deserializing objects that contain AppService.
 */
