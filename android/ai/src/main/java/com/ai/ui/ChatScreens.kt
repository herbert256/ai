...
fun ChatParametersScreen(
    ...
    Column(
        ...
        Column(
            ...
            if (Parameter.SYSTEM_PROMPT in supportedParams) {
                OutlinedTextField(
                    value = systemPrompt,
            ...
            // Temperature
            if (Parameter.TEMPERATURE in supportedParams) {
                OutlinedTextField(
                    value = temperature,
            ...
            // Max Tokens
            if (Parameter.MAX_TOKENS in supportedParams) {
                OutlinedTextField(
                    value = maxTokens,
            ...
            // Top P
            if (Parameter.TOP_P in supportedParams) {
                OutlinedTextField(
                    value = topP,
            ...
            // Top K
            if (Parameter.TOP_K in supportedParams) {
                OutlinedTextField(
                    value = topK,
            ...
            // Frequency Penalty
            if (Parameter.FREQUENCY_PENALTY in supportedParams) {
                OutlinedTextField(
            ...
            // Presence Penalty
            if (Parameter.PRESENCE_PENALTY in supportedParams) {
                OutlinedTextField(
            ...
            if (Parameter.SEARCH_ENABLED in supportedParams) {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
            ...
            if (Parameter.RETURN_CITATIONS in supportedParams) {
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
            ...
            if (Parameter.SEARCH_RECENCY in supportedParams) {
                OutlinedTextField(
                    value = searchRecency,
...
fun ChatSessionScreen(
    ...
    fun estimateTokens(text: String): Int = AppViewModel.estimateTokens(text)
    ...
    Column(
        ...
        // Chat messages area
        Card(
            colors = CardDefaults.cardColors(containerColor = AppColors.DisabledBackground),
            modifier = Modifier
                .fillMaxWidth()
                .weight(1f)
        ) {
...
private fun ChatMessageBubble(message: ChatMessage, userName: String = "You") {
    ...
    val backgroundColor = if (isUser) AppColors.Purple else AppColors.SurfaceDark
    ...
    Card(
        ...
        Column(
            ...
            Text(
                ...
                color = if (isUser) Color.White.copy(alpha = 0.7f) else AppColors.Blue,
                fontSize = 11.sp,
                fontWeight = FontWeight.Medium
            )
            Spacer(modifier = Modifier.height(4.dp))
            ...
            Row(
                ...
                Row {
                    TextButton(
                        ...
                        Text("< Previous", color = if (currentPage > 0) AppColors.Blue else AppColors.TextDisabled)
                    }
                    ...
                    TextButton(
                        ...
                        Text("Next >", color = if (currentPage < totalPages - 1) AppColors.Blue else AppColors.TextDisabled)
                    }
                }
            }
...
private fun ChatHubCard(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(
            containerColor = if (enabled) AppColors.CardBackgroundAlt else Color(0xFF3A3A3A)
        )
    ) {
        Row(
            modifier = Modifier
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .focusRequester(focusRequester),
                placeholder = { Text("Search in messages...", color = AppColors.TextTertiary) },
                singleLine = true,
                ...
                trailingIcon = {
                    TextButton(
                        ...
                        Text("Search", color = if (searchQuery.isNotBlank()) AppColors.Blue else AppColors.TextDisabled)
                    }
                }
            )
                        ...
                        Card(
                            ...
                            Column(
                                ...
                                Text(
                                    ...
                                    color = if (result.messageRole == "user") AppColors.Blue else AppColors.Green,
                                    fontSize = 12.sp
                                )
                                Spacer(modifier = Modifier.height(4.dp))
