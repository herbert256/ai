 ...
 */
fun AnalysisRepository.sendChatMessageStream(
    service: AppService,
    apiKey: String,
    model: String,
 ...
 */
internal fun AnalysisRepository.parseOpenAiSseStream(responseBody: ResponseBody): Flow<String> = flow {
 ...
 */
internal fun AnalysisRepository.parseOpenAiResponsesSseStream(responseBody: ResponseBody): Flow<String> = flow {
    val reader = responseBody.charStream().buffered()
    try {
        var line: String?
 ...
 */
internal fun AnalysisRepository.parseClaudeSseStream(responseBody: ResponseBody): Flow<String> = flow {
    val reader = responseBody.charStream().buffered()
    try {
        var line: String?
        var eventType: String? = null
 ...
 */
internal fun AnalysisRepository.parseGeminiSseStream(responseBody: ResponseBody): Flow<String> = flow {
    val reader = responseBody.charStream().buffered()
    try {
        var line: String?
        while (reader.readLine().also { line = it } != null) {
...
internal fun AnalysisRepository.streamChatClaude(
    apiKey: String,
    model: String,
    messages: List<com.ai.data.ChatMessage>,
    params: com.ai.data.ChatParameters,
    ...
    val api = ApiFactory.createClaudeStreamApiWithBaseUrl(baseUrl)
...
internal fun AnalysisRepository.streamChatGemini(
    apiKey: String,
    model: String,
    messages: List<com.ai.data.ChatMessage>,
    params: com.ai.data.ChatParameters,
    ...
    val api = ApiFactory.createGeminiStreamApiWithBaseUrl(baseUrl)
 ...
 */
internal fun AnalysisRepository.streamChatOpenAiCompatible(
    service: AppService,
    apiKey: String,
    model: String,
    messages: List<com.ai.data.ChatMessage>,
    ...
    if (usesResponsesApi(service, model)) {
        val api = ApiFactory.createOpenAiStreamApiWithBaseUrl(baseUrl)
        ...
        val api = ApiFactory.createOpenAiCompatibleStreamApi(baseUrl)
