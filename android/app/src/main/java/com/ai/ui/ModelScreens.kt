                ...
                Column(
                    ...
                    TextButton(
                        ...
                        Row(
                            ...
                            Text("Start AI Chat", color = AppColors.Blue)
                        }
                    }
                    // Create AI Agent
                    TextButton(
                        ...
                        Row(
                            ...
                            Text("🤖", fontSize = 20.sp)
                            Spacer(modifier = Modifier.width(12.dp))
                            Text("Create AI Agent", color = AppColors.Blue)
                        }
                    }
                    // Model Info
                    TextButton(
                        ...
                        Row(
                            ...
                            Spacer(modifier = Modifier.width(12.dp))
                            Text("Model Info", color = AppColors.Blue)
                        }
                    }
                }
            },
    ...
    if (showAgentEdit && editModel != null) {
        ...
        AgentEditScreen(
            ...
            onSave = { newAgent ->
                ...
                onSaveSettings(aiSettings.copy(agents = newAgents))
                showAgentEdit = false
                selectedModel = null
            },
            onBack = {
...
/**
 * Helper to convert provider name to AppService.
 */
internal fun providerFromName(name: String): AppService {
    return AppService.entries.find { it.displayName == name } ?: AppService.entries.first()
}
...
fun ModelInfoScreen(
    ...
    LaunchedEffect(modelName) {
        ...
        try {
            ...
            if (openRouterApiKey.isNotBlank()) {
                try {
                    val api = com.ai.data.ApiFactory.createOpenRouterModelsApi("https://openrouter.ai/api/")
            ...
            if (huggingFaceApiKey.isNotBlank()) {
                try {
                    val api = com.ai.data.ApiFactory.createHuggingFaceApi()
                    val modelIds = listOf(
                        modelName,
                        modelName.replace(":", "/"),
    ...
    LaunchedEffect(modelName) {
        ...
        try {
            ...
            val repository = com.ai.data.AnalysisRepository()
