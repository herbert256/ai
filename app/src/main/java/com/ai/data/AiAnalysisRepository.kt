...
class AiAnalysisRepository {
    ...
    // Legacy per-provider API instances (used by Chat and Models, will be removed in later steps)
    ...
    // Legacy per-provider streaming API instances (used by Streaming, will be removed in later steps)
