...
data class AiUiState(
    ...
    val availableNvidiaModels: List<String> = emptyList(),
    val isLoadingNvidiaModels: Boolean = false,
    val availableReplicateModels: List<String> = emptyList(),
    val isLoadingReplicateModels: Boolean = false,
    val availableHuggingFaceInferenceModels: List<String> = emptyList(),
    val isLoadingHuggingFaceInferenceModels: Boolean = false,
    val availableLambdaModels: List<String> = emptyList(),
    val isLoadingLambdaModels: Boolean = false,
    val availableLeptonModels: List<String> = emptyList(),
    val isLoadingLeptonModels: Boolean = false,
    val availableYiModels: List<String> = emptyList(),
    val isLoadingYiModels: Boolean = false,
    val availableDoubaoModels: List<String> = emptyList(),
    val isLoadingDoubaoModels: Boolean = false,
    val availableRekaModels: List<String> = emptyList(),
    val isLoadingRekaModels: Boolean = false,
    val availableWriterModels: List<String> = emptyList(),
    val isLoadingWriterModels: Boolean = false,
