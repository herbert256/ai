...
**Status:** Fixed (this session) — AnimatedTextLines drops to 80ms cadence + snap-to-full when lines > 30
...
**Proposed fix:** `lowercase(Locale.ROOT)`.
**Status:** Fixed (this session) — QuickLocalSearch needle uses Locale.ROOT lowercase
...
**Status:** Fixed (this session) — persistSourceLocally appends UUID short to avoid same-millisecond filename collision
