...
Four dispatch paths cover all 48 bundled cloud providers. Identity is
...
`ProviderRegistry.importFromAsset`. Across the 48 provider files,
...
## OPENAI_COMPATIBLE (default — 45 of 48 providers)
