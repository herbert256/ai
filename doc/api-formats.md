...
Four dispatch paths cover all 49 bundled cloud providers. Identity is
...
`ProviderRegistry.importFromAsset`. Across the 49 provider files,
**46 are `OPENAI_COMPATIBLE`, 1 is `ANTHROPIC` (the `Anthropic`
...
## OPENAI_COMPATIBLE (default — 46 of 49 providers)
