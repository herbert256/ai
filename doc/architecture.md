...
└─────────────────────────────────────────────────────────────────────┘
                              ...
                              ▼
            ┌──────────────────────────────────────────┐
            │  External APIs (43 cloud providers)      │
...
provider identity, so **41 of the 43 bundled providers share unified
...
> OpenAI-compatible" is stale — the real count is 41.
...
### `ProviderRegistry` — the 43 providers are an asset, not Kotlin

The 43 cloud providers are **not** hardcoded in Kotlin. They are bundled
as **one JSON file per provider under `assets/providers/`** (43 files,
