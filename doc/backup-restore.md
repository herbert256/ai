...
| `provider_registry` | Custom provider definitions added or imported by the user, keyed by provider id. The 43 bundled providers come from `assets/providers/` (one JSON file per provider) at runtime, not from this file. |
